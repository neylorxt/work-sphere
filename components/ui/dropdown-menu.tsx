...
>(({ className, sideOffset = 6, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        "z-50 min-w-[9rem] overflow-hidden rounded-lg border bg-popover p-1 text-popover-foreground shadow-lg data-[state=open]:animate-in data-[state=open]:fade-in-0 data-[state=open]:zoom-in-95 data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=closed]:zoom-out-95",
        className
      )}
      {...props}
    />
...
>(({ className, inset, asChild = false, ...props }, ref) => {
  const Comp = (asChild ? Slot : DropdownMenuPrimitive.Item) as React.ElementType;
  return (
    <Comp
      ref={ref}
      className={cn(
    ...
    <span className="absolute left-2 flex size-3.5 items-center justify-center">
      <DropdownMenuPrimitive.ItemIndicator>
        <svg viewBox="0 0 12 12" className="size-3.5 fill-current">
          <path d="M9.5 3.5l-4 4.5L3 5.5" stroke="currentColor" strokeWidth="1.6" fill="none" />
        </svg>
      </DropdownMenuPrimitive.ItemIndicator>
    </span>
    {children}
